...
*  Date: 6-1-21
*  Homework 5
*  File name: dec_client 
*  Description: This program connects to dec_server and will ask it to decrypt ciphertext using a passed-in ciphertext and key
*  Main source: client.c program given to us in assignment and modules code
*******************/
...
void sendData(char* filename, int socketFD, int length) {
    ...
    //as long as charsRead is greater than 0
    while (charsRead > 0) {
